...
<html lang="en">
    ...
    <body>
        ...
        <div class="page-wrapper Site1-theme toggled">
            <nav id="sidebar" class="sidebar-wrapper sidebar-dark">
                <div class="sidebar-content" data-simplebar style="height: calc(100% - 60px);">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="sidebar">
                            <a href="withdraw.php"><i class="ti ti-user me-2"></i>Withdraw Money</a>
                           
                        </li>
                        <li class="sidebar">
                            <a href="refer.html"><i class="ti ti-apps me-2"></i>Referral Code</a>
                    ...
                    .<div class="header-bar d-flex justify-content-between">
                        <div class="d-flex align-items-center">
                            <a href="#" class="logo-icon me-3">
                                <img src="assets/images/logo1.png" height="30" class="small" alt="">
                                <span class="big">
                                    <img src="assets/images/logo1.png" height="24" class="logo-light-mode" alt="">
                ...
                <div class="container-fluid">
                    <div class="layout-specing">
                     ...
                     <div class="row">
                        ...
                        <div class="col-md-8">
                            <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Refer link">
                                ...
                                <div class="p-4">
                                    <div class="table-responsive bg-white shadow rounded">
                                        <table class="table mb-0 table-center">
                                            <thead>
                                                <tr>
                                                <th scope="col" class="border-bottom">1</th>
                                    ...
                                    <div class="table-responsive bg-white shadow rounded">
                                        <table class="table mb-0 table-center">
                                            <thead>
                                                ...
                                                <th scope="col" class="border-bottom">Username</th>
                                                <th scope="col" class="border-bottom">Total Amount Received</th>
                                                <th scope="col" class="border-bottom">Email</th>
                                                </tr>
                                            </thead>
                                            <tbody>
